...
import {Packratter} from '../lib/scanner.js';
import {bnf, metaCompile, doBnf} from '../lib/bootbnf.js';
import {scannerless} from '../lib/scannerless.js';
...
export const {} = (function () {
  ...
  const arithRules = [
    ...
    ['def', 'expr', ['or', ['act', ['term', '"+"', 'expr'], 1], 'term']],
    ['def', 'term', ['or', ['act', ['NUMBER'], 2], ['act', ['HOLE'], 3], ['act', ['"("', 'expr', '")"'], 4]]],
  ];
